...
function Dashboard() { 
  ...
  // Function to fetch user profile data (replace this with your own logic)
  // const fetchUserProfile = () => {
  //   // Mocking API call, replace with your actual API call
                ...
                <ul class="navbar-nav  justify-content-end">
                  <li class="nav-item d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-white font-weight-bold px-0">
                      ...
                      <span class="d-sm-inline d-none">Hi, {userProfile?.firstName}</span>
                    </a>
                  </li>
                ...
                <div class="row align-items-center justify-content-lg-between">
                  <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="copyright text-center text-sm text-muted text-lg-start">
                      ...
                      <a href="#" class="font-weight-bold" target="_blank" rel="noreferrer">#####</a>
                    </div>
                  </div>
                  {/* <div class="col-lg-6">
