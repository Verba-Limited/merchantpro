export const ERROR_CLOSE = () => {
  return (
    ...
    >
      <path
        d="M37.5 37.5L62.5 62.5M62.5 37.5L37.5 62.5M87.5 50C87.5 70.7107 70.7107 87.5 50 87.5C29.2893 87.5 12.5 70.7107 12.5 50C12.5 29.2893 29.2893 12.5 50 12.5C70.7107 12.5 87.5 29.2893 87.5 50Z"
        stroke="#234A75"
        strokeWidth="4"
        strokeLinecap="round"
